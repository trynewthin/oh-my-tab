...
function baseMockGridItems(t: (key: string) => string): GridItem[] {
  return [
    {
      id: "mock-github",
      kind: "tab",
...
function additionalMockGridItems(t: (key: string) => string): GridItem[] {
  return [
    {
      id: "mock-more-linear",
      kind: "tab",
