...
export default {
  design: {
    ...
    elapsed: "天前",
    addDate: "留一个值得期待的日子",
    countdownHint: "写下日期和名字，等待下一次出发。",
    onlyHere: "本地便签",
    pauseShort: "暂停",
    startShort: "专注",
    focusing: "现在，只做这一件事",
    yourPace: "按自己的节奏",
    localNight: "当地晚间／夜间（18:00–06:00）",
    localDay: "当地日间（06:00–18:00）",
    illustration: "示例风景插画",
    addPhoto: "放一张喜欢的照片",
    photoHint: "来自你的设备，不上传到任何地方。",
    folderHint: "常用的链接，少一层展开。",
    setLocation: "选一个关心的地方",
    weatherHint: "手动填写坐标，不读取设备定位。",
    addFeed: "留一点阅读的空间",
    rssHint: "添加一个喜欢的订阅源。",
    feedPreviewThree: "留给一个悠闲下午的阅读清单",
    readyToLoad: "点击加载，再看一眼",
    cancelLoad: "取消加载",
    example: "示例",
    previewTitle: "效果预览",
    previewHint: "按实际比例展示 · 预览中的时间已暂停",
    editorHint: "调整样式，让它更适合你的桌面。",
  },
  configure: "配置组件",
  today: "今天",
  daysLeft: "还剩 {{count}} 天",
  ...
  countdownHelp:
    "4×2 突出第一个事件；4×4 在下方补充其余日期，按日历日期计算天数。",
  locationName: "地点名称",
  latitude: "纬度",
  longitude: "经度",
