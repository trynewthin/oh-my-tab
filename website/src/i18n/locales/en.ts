...
const resources: SiteResources = {
  ...
  privacy: {
    ...
    updatedLabel: "Updated: September 13, 2026",
    ...
    summary: {
      ...
      consent: {
        ...
        text: "Suggestions, favicons, and WebDAV are chosen and authorised by you.",
      },
      revoke: {
    ...
    sections: {
      ...
      "use-and-sharing": {
        ...
        paragraphs: [
          ...
          "When you use a third-party search, favicon, or WebDAV service, data is received by the service you chose, and its retention and deletion practices are governed by that service's own policy. The developer cannot promise a third party's log retention period.",
        ],
      },
      contact: {
