...
export default {
  design: {
    ...
    elapsed: "days ago",
    addDate: "Something to look forward to",
    countdownHint: "A date, a name. Keep the anticipation.",
    onlyHere: "Local note",
    pauseShort: "Pause",
    startShort: "Focus",
    focusing: "ONE THING AT A TIME",
    yourPace: "AT YOUR OWN PACE",
    localNight: "Local evening / night (18:00–06:00)",
    localDay: "Local daytime (06:00–18:00)",
    ...
    rssHint: "Bring a publication you enjoy.",
    feedPreviewThree: "A reading list for a slower afternoon",
    readyToLoad: "Ready when you are",
    cancelLoad: "Cancel loading",
    example: "Example",
    previewTitle: "Preview",
    previewHint: "Actual proportions · time is paused in preview",
    editorHint: "Shape the card around the way you use it.",
  },
  configure: "Configure",
  today: "Today",
  ...
  remove: "Remove",
  addEvent: "Add event",
  notePreview: "Leave room for a good idea.\n\nOne thing that matters today.",
  ...
  feedPreviewOne: "Small details, better everyday tools",
  feedPreviewTwo: "On making room for what matters",
